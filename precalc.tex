...
\ex{6: What rate of interest compounded annually should you seek if you want to double your investment in 5 years?}{
	...
	Divide by P~\[ 2=(1+\frac{r}{1})^{1\cdotp5}\]
...
\ex{4: An object is heated to 100C and is then allowed to cool in a room whose air temperature is 30C?}{
\[u(t)=T+(u_{0}-T)e^{kt}\]
\begin{enumerate}
    \item Find $k$:
    \begin{enumerate}
        \item \[80=30+(100-30)e^{k\cdot\ 5})\]
        \item \[80=30+70e^{5k})\]
        \item \[\frac{50}{70}=e^{5k}\]
        \item \[\frac{5}{7}=e^{5k}\]
        \item \[k=\frac{\ln\frac{5}{7}}{5}\]
    \end{enumerate}
    \item If the temperature of the object is 80C after 5 minutes, when will the temperature be 50C?
    \begin{enumerate}
        \item \[50=30+(100-30)e^{\frac{\ln\frac{5}{7}}{5}\cdot\t}\]
        \item \[t=18.616\]
    \end{enumerate}
    \item What is the temperature after 30 minutes?
    \begin{enumerate}
        \item \[u(30)=30+(100-30)e^{\frac{\ln\frac{5}{7}}{5}\cdot\ 30}\]
        \item \[u=39.3\]
    \end{enumerate}
\end{enumerate}
}
