...
\begin{figure}
	\includegraphics[scale=0.4]{Chapter 13 - PCR.jpeg} \label{PCR}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=0.3]{Chapter 13 - Gel Electrophoresis.png} \label{Gel Electrophoresis}
\end{figure}
...
\begin{figure}
	\includegraphics[scale=1]{Chapter 13 - Cas9 RNA.jpg} \label{Cas9}
\end{figure}
...
\begin{figure}
	...
	\includegraphics[scale=0.5]{dabloon.png}
	\label{dabloonia}
\end{figure}
\end{document}